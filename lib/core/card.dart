...
late int time; // время следуещего показа карточки в прямом направлении
late int timeR; // время следуещего показа карточки в обратном направлении
...
late int durationR; // пауза перед следующим показом в обратном направлении
  ...
  Card({
    ...
    required this.foreign
      ...
      time = DateTime.now().millisecondsSinceEpoch + 31536000; // + год
      timeR = DateTime.now().millisecondsSinceEpoch + 31536000; // + год
      duration = -1;
      durationR = -1;
    }
